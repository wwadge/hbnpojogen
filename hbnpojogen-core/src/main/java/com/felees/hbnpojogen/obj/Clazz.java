...
//        this.classNameNoSuffix = name;
    ...
    public boolean isImmutable() {
        ...
        Boolean staticTest = immutableTables.get(this.getTableObj().getDbCat()+".*");
        if (staticTest == null){
            staticTest = immutableTables.get("*."+this.getTableObj().getDbName());
            if (staticTest == null){
                staticTest = immutableTables.get("*.*");
                if (staticTest == null){
                    staticTest = immutableTables.get(this.getTableObj().getDbCat()+"."+this.getTableObj().getDbName());
                }
            }
        }
    ...
    public boolean isImmutableAndNotStaticTest() {
        ...
        return (staticTest != null) && (staticTest == false);
